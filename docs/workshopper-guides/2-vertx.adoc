...
Before you begin your exercises a few things you should know:
...
NOTE: Don't forget to stop the application between runs. you can do this by closing the Terminal in your Che/CodeReady workspace.
